...
from django.utils.translation import gettext_lazy as _  # recomendado usar gettext_lazy em models
...
class Base(models.Model):
    criado = models.DateField(_('Data de criação'), auto_now_add=True)
    modificado = models.DateField(_('Data de atualização'), auto_now=True)
